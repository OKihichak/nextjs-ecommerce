    ...
    return(
      ...
      <div className="mb-8 flex flex-wrap justify-between md:mb-16">
        <div className=" mb-6 flex w-full flex-col justify-center sm:mb-12 lg:mb-0 lg:w-1/3 lg:pb-24 lg:pt-48">
          ...
          Exclusive Collection: Up to 70% Off!
          </h1>
          <p className="max-w-md leading-relaxed text-gray-500 xl:tex-lg ">
          Discover our latest range of winter essentials. Cozy up in stylish
      sweaters, jackets, and hoodies—all at unbeatable prices. Don't miss
      out on our limited-time offers!
          </p>
        </div>

        <div className="mb-12 flex w-full md:mb-16 lg:w-2/3 ">
          <div className="relative top-12 left-12 z-10 -ml-12 overflow-hidden rounded-lg bg-gray-100 shadow-lg md:left-16 md:top-16 lg:mb-0 ">
            <Image
